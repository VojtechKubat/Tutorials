...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = NSBundle.mainBundle().URLForResource("FRCTutorialModel", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: "cz.certicon.FRCTutorial", code: 1001, userInfo: userInfo)

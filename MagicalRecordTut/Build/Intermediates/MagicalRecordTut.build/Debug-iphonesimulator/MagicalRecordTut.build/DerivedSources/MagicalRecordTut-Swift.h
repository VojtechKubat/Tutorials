...
SWIFT_CLASS("_TtC16MagicalRecordTut11AppDelegate")
...
SWIFT_CLASS("_TtC16MagicalRecordTut4Note")
...
@interface Note (SWIFT_EXTENSION(MagicalRecordTut))
@property (nonatomic, strong) NSDate * __nullable date;
@property (nonatomic, copy) NSString * __nullable title;
@property (nonatomic, copy) NSString * __nullable body;
@property (nonatomic, strong) NSSet * __nullable taggedBy;
@end

@class UILabel;
@class NSCoder;

SWIFT_CLASS("_TtC16MagicalRecordTut17NoteTableViewCell")
...
SWIFT_CLASS("_TtC16MagicalRecordTut14ViewController")

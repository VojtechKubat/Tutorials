...
class BeerDetailViewController: UITableViewController {
  ...
  required init(coder aDecoder: NSCoder) {
    ...
    amRatingCtl.addTarget(self, action: #selector(BeerDetailViewController.updateRating), forControlEvents: UIControlEvents.TouchUpInside)
  }
  //#####################################################################
  ...
  override func viewDidLoad() {
    ...
    func addButtons() {
        navigationItem.leftBarButtonItem  = UIBarButtonItem(title: "Cancel",
                                                            ...
                                                            target: self,
                                                            action: #selector(BeerDetailViewController.cancelAdd))
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Done",
                                                            style: UIBarButtonItemStyle.Done,
                                                            target: self,
                                                            action: #selector(BeerDetailViewController.addNewBeer))
    }
